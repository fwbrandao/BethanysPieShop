...
namespace BethanysPieShop.Models
{
    public class MockPieRepository : IPieRepository
    {
        ...
        private void InitializePies()
        {
            _pies = new List<Pie>
                {
                    new Pie {Id = 1, Name = "Apple Pie", Price = 12.95M, ShortDescription = "Our famous apple pies!", LongDescription = "The basis of Dutch apple pie is a crust on the bottom and around the edges. This crust is then filled with pieces or slices of apple, usually a crisp and mildly tart variety such as Goudreinet or Elstar. Cinnamon and sugar are generally mixed in with the apple filling", ImageUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/applepie.jpg", IsPieOfTheWeek = true, ImageThumbnailUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/applepiesmall.jpg"},
